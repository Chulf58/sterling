...
export const configSchema = z.object({
  ...
  store_guard: z
    .object({
      allow_scripts: z
        .array(z.string())
        .default(['scripts/dispose-run.mjs', 'scripts/init.mjs', 'scripts/consume-exit.mjs', 'scripts/architecture-projection.mjs', 'scripts/domain-doctor.mjs', 'scripts/commit-reviewed.mjs', 'scripts/migration-preflight.mjs', 'scripts/migrate-stores.mjs', 'sterling-tui.mjs']),
    })
    .default({}),
