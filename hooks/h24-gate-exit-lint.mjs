...
var gates = new Set(BUILTIN_FLOOR);
try {
...
var gateList = [...gates].sort((a, b) => b.length - a.length);
...
Command: ${command}
Never append ';' or '||' after a gate \u2014 a red suite must never read green. Run the gate as the last command, or chain with '&&' \u2014 a red exit propagates. Board 7d88b237.`
  );
}
allow();
