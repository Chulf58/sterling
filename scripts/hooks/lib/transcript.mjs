...
// readFromStart (a forward-read-from-byte-0 sibling of readTail, added for
// H22's Stop-time reviewer binding, decision foreign_edbaa38d) is DELETED —
// that reviewer-territory Stop-bind was already retired (see
// h22-dispatch-register.mjs's own SubagentStop comment) and readFromStart had
// acquired zero production callers; its only exerciser was the PART 5 pins in
// the now-deleted scripts/tests/h22-observed-territory.test.mjs.
