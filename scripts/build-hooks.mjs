...
// shipped-path default, the strict flag parsing, and the advisory. The
// freshness checker calls the same buildHooks() into a temp target, so the
// options CANNOT drift between builder and checker.
...
const emitted = await buildHooks({ root, srcDir, outDir });
