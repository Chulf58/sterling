...
// 706dd57 (run the pr-review-loop skill after a work-mode PR) and 993c29b (a
// store-unsettleable consequential choice goes through the grill skill, decision
// sterling-grill-skill-design), so its pin moves to 993c29b; every other template
// stays pinned to 703a327.
