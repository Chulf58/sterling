...
- **New features get a new owning article** (linked to what they depend on); **new domain concepts get a concept article (intent + interactions)**; renames and moves rewrite `file_keys` on every owning record so knowledge is never orphaned.
